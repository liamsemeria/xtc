...
// CHECK-NEXT:      } : !transform.any_op
// CHECK-NEXT:      %tiled_linalg_op_6, %loops_7 = transform.structured.tile_using_for %second tile_sizes [1, 0, 0] : (!transform.any_op) -> (!transform.any_op, !transform.any_op)
// CHECK-NEXT:      transform.annotate %loops_7 "__node0__/k[1]/i" : !transform.any_op
...
// CHECK-NEXT:      transform.annotate %loops_9 "__node0__/k[1]/j0" : !transform.any_op
