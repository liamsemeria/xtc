...
// CHECK-NEXT:      %tiled_linalg_op, %loops = transform.structured.tile_using_for %first tile_sizes [1, 0] : (!transform.any_op) -> (!transform.any_op, !transform.any_op)
...
// CHECK-NEXT:      %tiled_linalg_op_2, %loops_3 = transform.structured.tile_using_for %second tile_sizes [1, 0] : (!transform.any_op) -> (!transform.any_op, !transform.any_op)
