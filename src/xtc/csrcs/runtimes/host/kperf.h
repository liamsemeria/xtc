...
#define KPERF_UNUSED __attribute__((unused))
...
static const char *kpep_config_error_names[KPEP_CONFIG_ERROR_MAX] KPERF_UNUSED = {
    "none",
    "invalid argument",
    "out of memory",
    "I/O",
...
static const char *profile_event_names[] KPERF_UNUSED = {
#define PROFILE_EVENTS_ENUM(name, value) #name,
    PROFILE_EVENTS_LIST(PROFILE_EVENTS_ENUM, PROFILE_EVENTS_DISABLE)
#undef PROFILE_EVENTS_ENUM
};
...
static bool KPERF_UNUSED config_perf_counters(struct perf_counters *counters) {
  int ret;
